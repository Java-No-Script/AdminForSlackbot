...
export default function CrawlerPage() {
  const [crawlJobs, setCrawlJobs] = useState(defaultCrawlJobs);
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Textarea
                  id="urlPatterns"
                  placeholder="수집할 페이지의 URL 패턴을 한 줄씩 입력하세요"
                  rows={3}
                  className="mt-2"
                />
              </div>
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">
                          마지막 실행: {job.lastRun} | 수집된 페이지:{" "}
                          {job.pagesCollected}개
                        </p>
                      </div>
                    </div>
