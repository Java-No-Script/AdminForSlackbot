...
export const crawlingControllerCrawlWebsiteWithEmbedding = (
 ...
 options?: SecondParameter<typeof customInstance>,signal?: AbortSignal
      ...
      headers: {'Content-Type': 'application/json', },
      data: advancedCrawlRequest, signal
    },
      options);
    }
...
export const getCrawlingControllerCrawlWebsiteWithEmbeddingMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof crawlingControllerCrawlWebsiteWithEmbedding>>, TError,{data: AdvancedCrawlRequest}, TContext>, request?: SecondParameter<typeof customInstance>}
): UseMutationOptions<Awaited<ReturnType<typeof crawlingControllerCrawlWebsiteWithEmbedding>>, TError,{data: AdvancedCrawlRequest}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof crawlingControllerCrawlWebsiteWithEmbedding>>, {data: AdvancedCrawlRequest}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CrawlingControllerCrawlWebsiteWithEmbeddingMutationBody = AdvancedCrawlRequest
